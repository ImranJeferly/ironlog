...
abstract final class SyncMappers {
  ...
  static Map<String, dynamic> exercise(ExerciseRow r) => {
    ...
    'isExplosive': r.isExplosive,
    'primaryMuscle': r.primaryMuscle?.name,
    'secondaryMuscle': r.secondaryMuscle?.name,
    'notes': r.notes,
    'isCustom': r.isCustom,
    'archived': r.archived,
  ...
  static ExercisesCompanion? exerciseFrom(Map<String, dynamic> m) {
    ...
    return ExercisesCompanion(
      ...
      isExplosive: Value(_bool(m['isExplosive'])),
      primaryMuscle: Value(_enumOf(Muscle.values, m['primaryMuscle'])),
      secondaryMuscle: Value(_enumOf(Muscle.values, m['secondaryMuscle'])),
  ...
  static TemplateExercisesCompanion? templateExerciseFrom(
    ...
    return TemplateExercisesCompanion(
      ...
      supersetGroup: Value(_int(m['supersetGroup'])),
      updatedAt: Value(updatedAt),
      deleted: Value(_bool(m['deleted'])),
      synced: const Value(true),
    );
  ...
  static DailyMetricsCompanion? metricFrom(Map<String, dynamic> m) {
    ...
    return DailyMetricsCompanion(
      ...
      chestCm: Value(_double(m['chestCm'])),
      waistCm: Value(_double(m['waistCm'])),
      hipsCm: Value(_double(m['hipsCm'])),
      armCm: Value(_double(m['armCm'])),
      thighCm: Value(_double(m['thighCm'])),
      neckCm: Value(_double(m['neckCm'])),
      updatedAt: Value(updatedAt),
      deleted: Value(_bool(m['deleted'])),
      synced: const Value(true),
    );
